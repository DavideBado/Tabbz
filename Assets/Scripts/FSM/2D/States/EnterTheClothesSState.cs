...
public class EnterTheClothesSState : StateMachineBehaviour
{
    ...
    private void ItemsMenuGen()
    {
        ...
        foreach (ClothesConfigData _cloth in GameManager.MyGameManager.ClothesShop.Clothings)
        {
            ...
            itemInfoInsta.GetComponent<ItemInShopInfoData>().IconImage.sprite = _cloth.Icon;
            ...
            itemInfoInsta.GetComponent<ItemInShopInfoData>().NameTxt.text = _cloth.Name;
            itemInfoInsta.GetComponent<ItemInShopInfoData>().DescriptionTxt.text = _cloth.Description();
            itemInfoInsta.GetComponent<ItemInShopInfoData>().PriceTxt.text = (_cloth.Price.ToString() + "$");
        }
    }
}
